...
(require scheme/match
         ...
         (file "../base.ss")
         (file "../era/era.ss")
         (file "../sql/sql-struct.ss")
         (file "sql-data-sig.ss")
         (file "sql-name-sig.ss")
         (file "sql-query-helpers-sig.ss")
         (file "sql-query-sig.ss"))
  ...
  (match func
    [(struct function (type op args))
     (case op
       ...
       [(append)             (display-expression/infix  args " || " imported out)]
       [(replace)            (display-expression/outfix args "replace(" ")" imported out)]
