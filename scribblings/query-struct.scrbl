...
It is rare that an application programmer has to interact directly with these structures: most of the forms below not provided via @scheme[(planet untyped/snooze)].
