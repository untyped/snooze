    ...
    (test-suite
     ...
     (test-case
      ...
      (let ([table1 (q:table 'table1)]
        ...
        (check-not-exn
         (lambda ()
           (let* ([field1 (q:field table1 'table1 type:integer)]
                  [agg1a  (q:count field1)]
                  [agg1b  (q:count* table1)]
                  [field2 (q:field table2 'field2 type:integer)]
     ...
     (test-case
      ...
      (let ([table1  (q:table 'table1)]
        ...
        (check-equal? (select-what-types (q:select #:what (list (q:field 'f1 table1 'field1 type:id)
                                                                ...
                                                                (q:field 'f4 table1 'field4 type:integer)
                                                                (q:field 'f5 table1 'field5 type:real)
                                                                (q:field 'f6 table1 'field6 type:symbol)
                                                                (q:field 'f7 table1 'field7 type:boolean)
                                                                (q:field 'f8 table1 'field8 type:time-tai))
                                                   #:from table1))
                      (list type:id type:revision type:text type:integer type:real type:symbol type:boolean type:time-tai)
                      "q:fields")
        ...
        (check-equal? (select-what-types (q:select #:what (list (q:count   (q:field 'f4 table1 'field4 type:integer))
                                                                (q:count*  table1)
                                                                (q:max     (q:field 'f4 table1 'field4 type:integer))
                                                                (q:min     (q:field 'f4 table1 'field4 type:integer))
                                                                (q:max     (q:field 'f5 table1 'field5 type:real))
                                                                (q:min     (q:field 'f5 table1 'field5 type:real))
                                                                (q:average (q:field 'f4 table1 'field4 type:integer))
                                                                (q:average (q:field 'f5 table1 'field5 type:real)))
                                                   #:from table1))
