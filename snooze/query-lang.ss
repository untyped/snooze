(module query-lang mzscheme
  ...
  ;; q:in : (U expr string integer symbol boolean ref) (U select (list-of (U string integer symbol boolean))) -> expr
  ...
  (provide/contract 
   ...
   [rename q:in        in        (-> atom/c (or/c select? (listof literal/c)) expr?)]
