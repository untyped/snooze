...
(define (expand-function stx)
  (syntax-case* stx (and or not + - * / abs floor ceiling round = <> < <= > >=
                         ...
                         append replace null? coalesce ->string ->symbol in if) symbolic-identifier=?
    ...
    [(regexp-replace*-ci arg1 arg2 arg3) #`(sql:regexp-replace*-ci #,@(map expand-expression+unquote (syntax->list #'(arg1 arg2 arg3))))]
    [(append             arg1 arg2)      #`(sql:append             #,@(map expand-expression+unquote (syntax->list #'(arg1 arg2))))]
    [(replace            arg1 arg2 arg3) #`(sql:replace            #,@(map expand-expression+unquote (syntax->list #'(arg1 arg2 arg3))))]
